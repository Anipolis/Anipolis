-- ================================================================
-- 033_anime_exchange_no_wait_lock.sql
-- Anime exchange: allow users to submit even if they already have waiting entries.
-- ================================================================

DROP INDEX IF EXISTS public.idx_anime_exchange_entries_one_waiting_per_user;
